...
public class AddInBlue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_in_blue);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gref = FirebaseDatabase.getInstance().getReference("Blue");
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        uref.child(user.getUid()).child("area").addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                Toast.makeText(AddInBlue.this,"Garbage Added",Toast.LENGTH_SHORT).show();
                                desc.setText("");
                                weight.setText("");
                            }
